const comics_books = [
    {
        ...
        address: "https://www.amazon.fr/s?k=comics+hulk&i=stripbooks&__mk_fr_FR=%C3%85M%C3%85%C5%BD%C3%95%C3%91&ref=nb_sb_noss",
        created: new Date()
    },
    {
        id: 2,
        ...
        name: "Superman",
        description: "Créé en janvier 1933 par le scénariste américain Jerry Siegel et le dessinateur canadien Joe Shuster alors qu’ils habitaient tous deux à Cleveland, le personnage fut vendu à Detective Comics. Il apparaît pour la première fois dans un Action Comics en juin 1938. Le personnage est ensuite repris dans plusieurs pièces radiophoniques, émissions de télévision, films, comic strips et jeux vidéo. Au vu du succès et de la notoriété de ses aventures, Superman est essentiel dans la création d’un genre propre aux super-héros2.",
        address: "https://www.amazon.fr/s?k=superman+comics&i=stripbooks&crid=2LUPUNZUBGIRE&sprefix=superman%2Cstripbooks%2C86&ref=nb_sb_ss_ts-doa-p_1_8",
        created: new Date()
    },
    {
        id: 3,
